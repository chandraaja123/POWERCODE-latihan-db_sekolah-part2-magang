...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"><strong>Tambah Data Pengguna</strong></h1>
</div>
                ...
                <div class="card">
                    <div class="card-body text-dark">
                        ...
                        <div class="form-group row col-md-12">
                            ...
                            <div class="col-sm-8">
                                <input type="text" required="" class="form-control" placeholder="Nama"  value="" name="nama">
                            </div>
                        </div>
                        ...
                        <div class="form-group row col-md-12">
                            ...
                            <div class="col-sm-8">
                                <input type="text" required="" class="form-control" placeholder="Kata Kunci" name="kata_kunci">
                            </div>
                        </div>

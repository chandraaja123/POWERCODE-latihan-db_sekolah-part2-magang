...
<?php 
        if(isset($_POST["btnSimpan"])){
            ...
            // Query Simpan Data
            $sql = "INSERT INTO tb_mapel (mapel)
                        VALUES ('$mapel')";
                ...
                <div class="card">
                    <div class="card-body text-dark">
                        ...
                        <div class="form-group row col-md-12">
                            <label for="inputPassword" class="col-sm-4 col-form-label">Nama Mata Pelajaran<font color="red"><strong>*</strong></font></label>
                            <div class="col-sm-8">
                                <input type="text" required="" class="form-control" placeholder="Input Mata Pelajaran" name="mapel">
                            </div>
                        </div>
